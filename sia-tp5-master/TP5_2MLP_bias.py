...
"""
################################################################
#Distintos niveles (todavía no anda el plot)

noise_levels = [0.1, 0.15, 0.2, 0.3]   # los que quieras

all_errors = {}   # para guardar errores promedio por nivel
all_recons = {}   # para guardar las reconstrucciones
...
for NOISE_P in noise_levels:
    ...
    plt.figure(figsize=(12, 6))
    plt.suptitle(f"Reconstrucciones con noise={NOISE_P}", fontsize=14)
